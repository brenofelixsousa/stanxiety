...
app.post('/save-response', function(req, res, next){
  ...
  var row = [respId, req.body.startTime, req.body.endTime, req.body.testType, req.body.pretestPoints, req.body.activityPoints, req.body.posttestPoints, req.body.pre, req.body.post, req.body.flowPoints,req.body.flow,req.body.name, req.body.gender, req.body.age, req.body.ethnicity, req.body.sexualOrientation, req.body.city, req.body.civilState, req.body.universityEducation , req.body.institucion, req.body.educationLevel ,req.body.conclusion ,  req.body.email, req.body.whatsapp].join(";")+"\n"
  ...
  fs.stat('responses.csv', function (err, stat) {
      if (err == null) {
          ...
          var headers= ["responseId", "startTime","endTime","testType","motivationPre","activityPoints","motivationPost","motivationRawPre","motivationRawPost", "flowRawPoints", "flow", "name","gender","age", "ethnicity", "sexualOrientation", "civilState", "city","universityEducation","institucion","educationLevel","conclusion", "email","whatsapp"].join(";") + "\n" + row
