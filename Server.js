...
app.post('/save-response', function(req, res, next){
  ...
  fs.stat('responses.csv', function (err, stat) {
      if (err == null) {
          ...
          var headers= ["responseId", "startTime","endTime","testType","motivationPre","activityPoints","motivationPost","motivationRawPre","motivationRawPost", "flowRawPoints", "flow", "gender","age", "ethnicity", "sexualOrientation", "civilState", "city","universityEducation","institucion","educationLevel","conclusion", "email","whatsapp"].join(";") + "\n" + row
